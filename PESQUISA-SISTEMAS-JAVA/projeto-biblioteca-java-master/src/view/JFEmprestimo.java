...
public class JFEmprestimo extends javax.swing.JFrame {  
    ...
    private void cadastraRegistro() throws SQLException {
        // Antes de cadastrar, verificar se o usuário está com algum registro selecionado
        if (!(jTableEmprestimo.getSelectedRow() != -1)) {
            // Antes de cadastrar, verificar se os campos foram preenchidos
            if (verificaDados()) {
    ...
    // Método p/ verificar se o livro está disponível
