...
public class consultaClientes extends javax.swing.JDialog {
    ...
    private static final int BUSCAR_TODOS_CLIENTES = 0;
    ...
    public void filtraClientes(int codigoCliente) {
        ...
        String sqlPessoa = "select * from pessoa where codigo = " + codigoCliente + " order by codigo";
        if (codigoCliente == BUSCAR_TODOS_CLIENTES) {
    ...
    public void atualizaTabelaClientes(String sqlPessoa){
        ...
        if(temClientes){
            JOptionPane.showMessageDialog(rootPane, "Listando clientes encontrados...");
            ...
            JOptionPane.showMessageDialog(rootPane, "Clientes não encontrados com o filtro informado!");
        }
    }
    ...
    public void atualizaConsulta(){
        ...
        if (botaoTodos.isSelected()) { //Todos
            filtraClientes(BUSCAR_TODOS_CLIENTES);
        } else if (botaoCodigo.isSelected()) { //Código
            if(edtConsulta.getText().equals("")){
                JOptionPane.showMessageDialog(rootPane, "Informe o codigo do cliente!");
            } else {
