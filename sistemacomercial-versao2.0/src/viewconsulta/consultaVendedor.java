 ...
 */
public class consultaVendedor extends javax.swing.JDialog {
     ...
     */
    public consultaVendedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                consultaVendedor dialog = new consultaVendedor(new javax.swing.JFrame(), true);
