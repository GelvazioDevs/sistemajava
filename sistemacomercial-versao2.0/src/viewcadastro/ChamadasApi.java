...
public class ChamadasApi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton5.setText("CHAMADA API");
        jButton5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton5ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 50, 170, 40));
    ...
    private void executaChamadaApi() throws MalformedURLException, IOException {
        ...
        // InputStream inputStream = new ByteArrayInputStream("Exemplo de texto".getBytes());
    ...
    public static void trataObjetoJson() {
        String json = "{\"nome\":\"Carlos\",\"idade\":40}";

        JSONObject jsonObject = new JSONObject(json);
        String nome = jsonObject.getString("nome");
        int idade = jsonObject.getInt("idade");

        System.out.println("TRATANDO JSON OBJETO");
